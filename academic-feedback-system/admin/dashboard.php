...
// Recent comments
$commentsQuery = $conn->query("SELECT comment, submitted_at FROM feedback ORDER BY submitted_at DESC LIMIT 5");
...
<body>
    ...
    <div class="dashboard">
        ...
        <div class="card">
            ...
            <a href="export_feedback.php" class="logout-btn" style="margin-top: 15px; background:#3498db">⬇️ Export CSV</a>
